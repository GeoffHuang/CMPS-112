...
{- | CS 112: Intro to Haskell Assignment.
...
-- more elegant solution - only call divMod once instead of twice:
digitsOfInt :: Int -> [Int]
digitsOfInt n
    | n <= 0    = []
    | otherwise = digitsOfInt d ++ [m]
...
additivePersistence n
    ...
    -- alternate ways to do the otherwise case:
    -- | otherwise = 1 + (additivePersistence . sumList . digitsOfInt) n
    -- | otherwise = (+1) $ additivePersistence $ sumList $ digitsOfInt n
